...
Building::Building(ShaderIF* sIF, float cx, float cy, float cz, PhongMaterial& p) : SceneElement(sIF)
{
    ...
    //first window
    blocks[1] = new Block(sIF, cx+0.5, cy+0.5, cz+5.1, 1.0, 1.0, 0.1, window);
    //door
    blocks[2] = new Block(sIF, cx+2.0, cy, cz+5.1, 1.0, 1.5, 0.1, door);
    //rest of the windows
    blocks[3] = new Block(sIF, cx+3.5, cy+0.5, cz+5.1, 1.0, 1.0, 0.1, window);
    blocks[4] = new Block(sIF, cx+0.5, cy+2.0, cz+5.1, 1.0, 1.0, 0.1, window);
    blocks[5] = new Block(sIF, cx+2.0, cy+2.0, cz+5.1, 1.0, 1.0, 0.1, window);
    blocks[6] = new Block(sIF, cx+3.5, cy+2.0, cz+5.1, 1.0, 1.0, 0.1, window);
    blocks[7] = new Block(sIF, cx+0.5, cy+3.5, cz+5.1, 1.0, 1.0, 0.1, window);
    blocks[8] = new Block(sIF, cx+2.0, cy+3.5, cz+5.1, 1.0, 1.0, 0.1, window);
    blocks[9] = new Block(sIF, cx+3.5, cy+3.5, cz+5.1, 1.0, 1.0, 0.1, window);
